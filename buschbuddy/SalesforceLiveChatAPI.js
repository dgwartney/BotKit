...
async function initChat(session, options, caseID) {
    ...
    var visitor_email = _.get(options, "emailId", null);
    //All jd here
    var visitor_firstName = _.get(options, "FirstName", null);
    var visitor_lastName = _.get(options, "LastName", null);
    var visitor_id = _.get(options, "contactId", null);
    var visitor_Name = _.get(options, "VisitorName", "bud");
    var caseNumber = _.get(options, "caseNumber", null);
    var caseId = _.get(options, "caseId", null);
    ...
    prechatDetails = [
     ...
     },
     {
        ...
        //JD Adding to get Case info there
        {
            "label": "CaseNumber",
            "value": caseNumber,
            "entityMaps": [
